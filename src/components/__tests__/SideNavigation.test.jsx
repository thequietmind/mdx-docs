...
describe('SideNavigation component', () => {
  ...
  beforeEach(() => {
    vi.spyOn(navigationUtils, 'getNavigationPages').mockReturnValue(mockNavigationPages);
  });
  ...
  it('should highlight the active route', () => {
    renderWithRouter(<SideNavigation {...defaultProps} />, { route: '/button' });
  ...
  it('should render drawer with correct width', () => {
    const { container } = renderWithRouter(<SideNavigation {...defaultProps} />);
