...
frontmatter. The page then renders full-width — useful for home pages, privacy
...
page. Only the `sidebar` field changes the layout — page `title` and
`description` are configured in `config/pages.js`.
