...
from that page. To keep light/dark switching on a toolbar-less page, drop the
standalone `ColorModeToggle` anywhere in your content and position it however
you like:
...
`footer: false` overrides the page only; the site-wide footer configuration in
