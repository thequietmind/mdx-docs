...
<Button variant="text" color="inherit">Text Button</Button>
...
<Button variant="contained" color="primary" sx={{ mr: 0.5, mb: 1 }}>Primary</Button>
<Button variant="contained" color="secondary" sx={{ mr: 0.5, mb: 1 }}>Secondary</Button>
<Button variant="contained" color="success" sx={{ mr: 0.5, mb: 1 }}>Success</Button>
<Button variant="contained" color="error" sx={{ mb: 1 }}>Error</Button>

## Sizes

Buttons come in three sizes to accommodate different design needs:

<Button size="small" variant="contained" sx={{ mr: 0.5, mb: 1 }}>Small</Button>
<Button size="medium" variant="contained" sx={{ mr: 0.5, mb: 1 }}>Medium</Button>
<Button size="large" variant="contained" sx={{ mb: 1 }}>Large</Button>
