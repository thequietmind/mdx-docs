...
One of the strengths of MDX is the ability to build reusable React components for your documentation. The examples below are components used on this site, along with their source code.
